package project.my222au.assignment3;
...
import project.my222au.assignment3.callCollector.CallCollector;
import project.my222au.assignment3.cityMap.MapsActivity;
import project.my222au.assignment3.theRoadMap.TheRoadmap;
...
public class MainActivity extends ListActivity {
    ...
    private void setup_activities() {
        addActivity("Call Collector ", CallCollector.class);
        addActivity("City Map",MapsActivity.class);
        addActivity("The Road map ",TheRoadmap.class);
